...
CREATE TABLE `tb_user_base` (
  ...
  `login_name` varchar(50) NOT NULL DEFAULT '' COMMENT '登录名称',
  `password` varchar(100) NOT NULL DEFAULT '' COMMENT '登录密码：加密形式',
  ...
  `image` varchar(500) NOT NULL DEFAULT '' COMMENT '头像路径',
...
CREATE TABLE `tb_user_address` (
  ...
  `province` varchar(100) NOT NULL DEFAULT '' COMMENT '省名称',
  `city` varchar(100) NOT NULL DEFAULT '' COMMENT '市区名称',
...
CREATE TABLE `tb_category` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '商品类别名称',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `delete_mark` tinyint(1) NOT NULL DEFAULT '1' COMMENT '软删除：0-删除 1-有效',
  `creator` varchar(50) NOT NULL DEFAULT '' COMMENT '创建人',
...
CREATE TABLE `tb_category_spu` (
  ...
  `title` varchar(30) NOT NULL DEFAULT '' COMMENT '商品描述',
...
CREATE TABLE `tb_category_item` (
  ...
  `place` varchar(100) NOT NULL DEFAULT '' COMMENT '发货地',
  `item_desc` varchar(1000) NOT NULL DEFAULT '' COMMENT '商品描述',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `delete_mark` tinyint(1) NOT NULL DEFAULT '1' COMMENT '软删除：0-删除 1-有效',
  `creator` varchar(50) NOT NULL DEFAULT '' COMMENT '創建人',
  `update_by` varchar(50) NOT NULL DEFAULT '' COMMENT '更新人',
  PRIMARY KEY (`id`)
...
CREATE TABLE `tb_trade_paylog` (
  ...
  `pay_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '支付类型：枚举值',
